window.onload = function() {
    ...
    JE = {
           ...
           /* JSON is converted to tree HTML, while formatting code */
            ...
            function notify(name /*节点名*/ , value /*节点值*/ , bool /*是否为最后一项*/ ) {
                if (value && value.constructor == Array) {
                    ...
                    var bracket = bool ? "]" : "],"
                    This.number++;
                    draw.push('<span oncopy="return false">' + This.number + '<span></dd><dt><em class="bracket">' + bracket + '</em></dt></dl>');
        ...
        highlight: function(nameStr, value, bracket, bool /*is it the last item*/ ) {
            ...
            switch (typeof value) {
                case "boolean":
                    return '<span  onselectstart="return false;">' + this.number + '</span><b  class="string">' + nameStr + ' <strong class="boolean">' + valueStr + '</strong>'
                    break;
                case "number":
                    return '<span  onselectstart="return false;">' + this.number + '</span><b  class="string">' + nameStr + ' <cite class="number">' + valueStr + '</cite>'
                    break;
                case "string":
                    {
                        if (bool) return '<span  onselectstart="return false;">' + this.number + '</span><b  class="string">' + nameStr +
                            '<b class ="string">"' + value + '"</b>';
                        else return '<span  onselectstart="return false;">' + this.number + '</span><b  class="string">' + nameStr +
                            '<b class ="string">"' + value + '" ,</b>';
                        break;
                    }
                case "object":
                    return '<span  onselectstart="return false;">' + this.number + '</span>\
